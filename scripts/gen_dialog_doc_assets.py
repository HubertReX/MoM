...
Tworzy dwa obrazki w ``doc/_attachements/`` z PRAWDZIWYCH modułów MoM (headless, SDL dummy):
...
``doc/_attachements/dialog-migration-plan.html``. Uruchom po dodaniu nowych emote/tagów, aby je odświeżyć.
