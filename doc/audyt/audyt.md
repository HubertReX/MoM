...
- [x] [A08 - web-runner: jeden serwer pygbag na przebieg + `just test-smoke`](A08-web-runner-jeden-pygbag-i-smoke.md) - P1 (znalezione w trakcie B01: obniża koszt bramek, robić równolegle)
