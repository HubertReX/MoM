...
Wszystkie **15 decyzji zamkniętych** (2026-07-16). Kod: **Q-01, Q-02, Q-03, Q-04, Q-05, Q-06
zrobione**, Q-10 naszkicowane (2026-07-16).

Zostały: **Q-07** (runtime: event-driven + sweep), **Q-08** (panel pod `J`, projekt gotowy
w HTML-u), **Q-09** (toasty, zależy od Q-07), **Q-11** (graf, #S). Wszystkie odblokowane,
żaden nie czeka na decyzję.

Silnik jest kompletny i przetestowany, ale **jeszcze nikt go nie woła** - `check_quests` nie
jest wpięte w pętlę gry (to Q-07). Do tego czasu questy nie zapalają się w grze, mimo że
`config.json` ma 8 questów, a save potrafi je przechować.
