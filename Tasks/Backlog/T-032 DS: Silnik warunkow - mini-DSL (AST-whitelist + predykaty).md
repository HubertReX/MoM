...
- 2026-07-06 07:38 cc: Zaktualizowany project/AGENTS.md: nowa sekcja 'System dialogów (dialog/)' pokrywająca T-029 (encje+builder) i T-032 (silnik warunków mini-DSL) + wiersz w mapie plików rdzenia i komendy do odpalenia testów.
