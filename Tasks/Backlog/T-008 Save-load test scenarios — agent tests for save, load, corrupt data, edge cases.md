...
- 2026-06-30 cc: Wykonano wszystkie scenariusze z tests/scenarios.json pojedynczo i zbiorczo. Gra nie crashuje. Znalezione problemy: (1) TestRunner w automate_display_test.py zabija grę po pierwszym scenariuszu i nie restartuje jej - kolejne scenariusze wykonują się na martwym procesie; (2) Save Overwrite wczytuje stan pośredni (czas 9:05) zamiast nadpisanego zapisu (czas 9:11-9:12); (3) Auto Save on Map Change nie zmienia mapy, więc nie testuje auto-save; (4) quick_load nie zamyka LoadPanel w scenariuszach Corrupt Save i Empty Slot. Szczegóły w nowych bug-taskach.
