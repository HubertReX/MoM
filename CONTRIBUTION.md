...
![GitHub last commit](https://img.shields.io/github/last-commit/hubertrex/MoM)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](https://opensource.org/licenses/MIT)

> **Forked from** [`HubertReX/MoM`](https://github.com/HubertReX/MoM) — branch [`NinjaAdventure`](https://github.com/HubertReX/MoM/tree/NinjaAdventure).
...
- [![GitHub Pages](https://img.shields.io/badge/github_pages-%23121011.svg?style=for-the-badge&logo=github&logoColor=white)](https://hubertrex.github.io/MoM/NinjaAdventure)
...
- usage of menus - custom solution build base on `pygame-menu`[^1] (patched - `gfxdraw` to work in the **web browser**)
...
- objects on map can be destroyed
- procedurally generated **mazes** with randomly placed **decors**
- semi-transparent panels and text with background (alpha blending)
- custom UI interface with rich text formatting and animated emojis/icons (inspired by the [Thorpy] and the [SFText])
- UI notifications system
- preliminary version dialogs with NPCs
...
- **day** and **night** cycle (implemented using shaders)
- functionality that allows **animate** any numerical value of the game like camera position, time of day allowing to create custom **cutscenes**
  ...
  - different kinds of **transitions** between changed values (_linear_, _quad_, _sin_, _anticipation_, _overshoot_  with '_in_', '_out_', '_in&out_' easing and more)
...
- game pause (manual and automatic when the game window is out of focus)
...
- game is not working in the **Firefox** browser
- Player should not be able to move after **colliding** with **map exit** box
...
- add **movable** objects (e.g. to unlcok exit, block enemy, etc)
- ✅ ~~add object **destruction**~~ - `done`
- ✅ ~~add item **drop/pickup** and **inventory** system~~ - `done`
- add random **items spawning** on the map
...
Manually run [pygbag_build](https://github.com/HubertReX/MoM/actions/workflows/pygbag.yml) GitHub action on selected branch.

Full instruction how to setup is [here](https://pygame-web.github.io/wiki/pygbag/github.io/).

## Atribution

This project is inspired by Matt Owen's tutorial:

[Pygame ARPG Tutorial Series](https://www.youtube.com/watch?v=a1NIscbsmKo&list=PLLdd2IQ6qKU7OAOpVdaK304D_BGSOw3iW&pp=iAQB)

This awesome [Ninja Adventure](https://pixel-boy.itch.io/ninja-adventure-asset-pack) asset pack, that makes this game look this good, is thanks to incredible work of [Pixel-Boy](https://twitter.com/2Pblog1) and [AAA](https://www.instagram.com/challenger.aaa/?hl=fr):

![](https://img.itch.zone/aW1nLzI2ODk0MzIxLnBuZw==/original/Ck7sz0.png)
